...
const ele5 = { title: 'title5', src: 'https://fiverr-res.cloudinary.com/image/upload/w_575/f_auto,q_auto/v1/attachments/generic_asset/asset/14724b958fcd42191d3bf941b6bbb72c-1650457672396/gray%20color-min.jpg', content: 'content5', author: 'author1', num: '5' };
...
localStorage.setItem('key5', JSON.stringify(ele5));